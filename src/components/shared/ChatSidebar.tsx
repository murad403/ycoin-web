...
const ChatSidebar = () => {
  ...
  const menuItems = [
    ...
    { label: 'Discover', icon: FiGrid, href: '/new-chat' },
    { label: 'Terms Of Conditions', icon: FiFileText, href: '/new-chat' },
    { label: 'Privacy Policy', icon: FiInfo, href: '/new-chat' },
  ]
  ...
  return (
    <aside className="w-64 md:w-72 bg-black border-r border-border-color h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] flex flex-col p-4 shrink-0 overflow-y-auto">
      
      {/* Search Input */}
      <div className="relative flex items-center bg-[#020813] border border-border-color rounded-xl px-3 py-2 mb-4 focus-within:border-button-color transition-colors">
