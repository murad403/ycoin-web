...
const Culture = () => {
    ...
    return (
        <section id="culture" className="w-full relative overflow-hidden py-16 md:py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {cards.map((card, idx) => {
                        ...
                        return (
                            <div
                                key={idx}
                                className="bg-[#090D14] border border-border-color hover:border-button-color rounded-2xl p-6 md:p-8 flex flex-col items-start text-left transition-all duration-300 shadow-md hover:shadow-button-color"
                            >
